...
public class GraphAssignment extends JPanel{
   
    private static final String TITLE = "Line Chart: Total Number Of Errors Within 6 Months";
    private static final String X_LABEL = "Months (in 2022)", Y_LABEL = "Number Of Error";
    private static final String[] X_DATA = new String[]{"June", "July", "August", "September", "October", "November", "December"};
    private static final int[] Y_DATA = new int[]{38, 0, 56, 9, 5, 35, 0};
    ...
    private static final int Y_DATA_SEP = 5;
    ...
    public static void main(String[] args) {
        ...
        JPanel panel = new GraphAssignment();
