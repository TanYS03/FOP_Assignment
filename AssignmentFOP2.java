...
public class AssignmentFOP2 {
    ...
    displaytReturnedMonthInTable();
        ...
        public static void totalkilljob(){
            ...
            System.out.println("Total number of job killed in 6 months.\n");
        ...
        public static void totalnewkilljob(){
            ...
            try{
                ...
                Scanner scanner = new Scanner(new FileInputStream("totalkilljob.txt"));
                PrintWriter writer = new PrintWriter(new FileWriter("totalkillnewjob"));
                ...
                while(scanner.hasNextLine()){
                    ...
                    if(matcher.find()){
                        for(String str : dates){
                            for(String abs : jobids){
                        if((matcher.group(1).compareToIgnoreCase(str)<0) && (matcher.group(3).equalsIgnoreCase(abs))){
                        dates.add(matcher.group(1));
                        jobids.add(matcher.group(3));
                        System.out.printf("| %15s | %20s     | %7s   | %10s |\n",matcher.group(1),matcher.group(2),matcher.group(3),matcher.group(4));
                        System.out.println("|-----------------------------------------------------------------------------|");
                       // writer.println(matcher.group(1) + " " + matcher.group(2) + " " + matcher.group(3) + " "  + matcher.group(4));
                       writer.println(line);
        ...
        try{
            BufferedReader reader = new BufferedReader(new FileReader("return2.txt"));
