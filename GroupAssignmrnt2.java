...
public class GroupAssignmrnt2 extends JPanel{

    private static final String TITLE = "Pie Chart: Type Of Partition";
    private static final String[] X_DATA = new String[]{"gpu-k10", "gpu-k40c", "gpu-v100s", "gpu-titan", "cpu-opteron", "cpu-epyc"};
    private static final int[] Y_DATA = new int[]{251, 128, 328, 408, 2024, 1689};
    ...
    public static void main(String[] args) {
        ...
        JPanel panel = new GroupAssignmrnt2();
